...
export function CTASection() {
  return (
    <section className="py-24 relative overflow-hidden bg-brand-navy">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=50&w=800&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-luminosity" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="text-white border-white hover:bg-white hover:text-brand-navy">View Our Projects</Button>
          </div>
        </div>
      </div>
    </section>
